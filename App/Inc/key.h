...
*/
#define keyUp gpio_get(PTA25);  //up
#define keyDown gpio_get(PTA16); //down
#define keyEnter gpio_get(PTA17); //enter
#define keyLeft gpio_get(PTA24); //left
#define keyRight gpio_get(PTA13); //right
